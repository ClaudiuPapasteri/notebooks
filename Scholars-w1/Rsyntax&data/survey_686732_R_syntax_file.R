...
data[, 47] <- factor(data[, 47], levels=c("AO02","AO03","AO04","AO05","AO06","AO07","AO10","AO08","AO09"),labels=c("Niciunul", "Școală primară (cls. I-IV)", "Școală gimnazială (cls. V-VIII)", "Studiile liceale (IX-XII)", "Unele studii postliceale", "Absolvent universitar", "Masterat", "Doctorat", "Nu știu/ Nu răspund"))
...
attributes(data)$variable.labels[222] <- "[Primesc foarte multă înțelegere și siguranță de la alții.]"
...
attributes(data)$variable.labels[223] <- "[Am o persoană foarte apropiată, pe ajutorul căreia pot conta mereu.]"
...
attributes(data)$variable.labels[224] <- "[Dacă am nevoie, pot împrunuta ceva de la prieteni sau vecini fără nicio problemă.]"
...
attributes(data)$variable.labels[225] <- "[Am mai multe persoane alături de care îmi place să fac lucruri/ să îmi petrec timpul.]"
...
attributes(data)$variable.labels[226] <- "[Când sunt bolnav/ă, pot apela fără ezitare la prieteni sau rude să se ocupe de lucrurile importante pentru mine.]"
...
attributes(data)$variable.labels[227] <- "[Dacă sunt foarte deprimat/ă, știu la cine pot apela.]"
...
attributes(data)$variable.labels[228] <- "[Majoritatea oamenilor consideră că adolescenții  cu probleme emoționale și de comportament sunt la fel de inteligenți ca toți ceilalți.]"
...
attributes(data)$variable.labels[229] <- "[Majoritatea oamenilor se uită de sus la  adolescenții care apelează la un psiholog pentru probleme emoționale sau de comportament.]"
...
attributes(data)$variable.labels[230] <- "[Celor mai mulți adolescenți le-ar plăcea să petreacă timp cu adolescenți cu probleme emoționale sau de comportament.]"
...
attributes(data)$variable.labels[231] <- "[Majoritatea oamenilor cred că adolescenții cu probleme emoționale sau de comportament sunt periculoși.]"
...
attributes(data)$variable.labels[232] <- "[Majoritatea oamenilor cred că adolescenții cu probleme emoționale sau de comportament nu sunt la fel de demni de încredere ca ceilalți.]"
...
attributes(data)$variable.labels[233] <- "[Majoritatea oamenilor cred că adolescenții cu probleme emoționale sau de comportament sunt de vină pentru problemele lor.]"
...
attributes(data)$variable.labels[234] <- "[Majoritatea oamenilor cred că adolescenții cu probleme emoționale sau de comportament se vor face bine într-o zi.]"
...
attributes(data)$variable.labels[235] <- "[Majoritatea angajatorilor cred că e o idee proastă să ofere o slujbă cu jumătate de normă unui adolescent cu probleme emoționale sau de comportament.]"
...
attributes(data)$variable.labels[236] <- "[Majoritatea oamenilor cred că adolescenții cu probleme emoționale sau de comportament pot obține note bune la școală.]"
...
attributes(data)$variable.labels[237] <- "[Profesorii cred că elevii cu probleme emoționale sau de comportament nu se comportă la fel de bine ca ceilalți la ore.]"
...
attributes(data)$variable.labels[238] <- "[Majoritatea oamenilor cred că adolescenții cu probleme emoționale sau de comportament nu pot avea grijă de ei înșiși la fel de bine ca ceilalți.]"
...
attributes(data)$variable.labels[239] <- "[Majoritatea oamenilor se tem de adolescenții care merg la psiholog pentru că au probleme emoționale sau de comportament.]"
...
attributes(data)$variable.labels[240] <- "[Cred că adolescenții cu probleme emoționale sau de comportament sunt la fel de inteligenți ca ceilalți.]"
...
attributes(data)$variable.labels[241] <- "[M-aș uita de sus la un adolescent dacă aș ști că merge la psiholog pentru probleme emoționale sau de comportament.]"
...
attributes(data)$variable.labels[242] <- "[Mi-ar plăcea să petrec timp cu cineva care are probleme emoționale sau de comportament.]"
...
attributes(data)$variable.labels[243] <- "[Cred că adolescenții cu probleme emoționale sau de comportament sunt periculoși.]"
...
attributes(data)$variable.labels[244] <- "[Cred că adolescenții cu probleme emoționale sau de comportament nu sunt la fel de demni de încredere ca ceilalți.]"
...
attributes(data)$variable.labels[245] <- "[Cred că adolescenții cu probleme emoționale sau de comportament sunt de vină pentru problemele lor.]"
...
attributes(data)$variable.labels[246] <- "[Cred că adolescenții cu probleme emoționale sau de comportament se vor face bine într-o zi.]"
...
attributes(data)$variable.labels[247] <- "[Cred că e o idee proastă ca angajatorii să ofere o slujbă cu jumătate de normă unui adolescent cu probleme emoționale sau de comportament.]"
...
attributes(data)$variable.labels[248] <- "[Cred că adolescenții cu probleme emoționale sau de comportament pot obține note bune la școală.]"
...
attributes(data)$variable.labels[249] <- "[Cred că adolescenții cu probleme emoționale sau de comportament nu se comportă la fel de bine ca ceilalți la ore.]"
...
attributes(data)$variable.labels[250] <- "[Cred că adolescenții cu probleme emoționale sau de comportament nu pot avea grijă de ei înșiși la fel de bine ca ceilalți.]"
...
attributes(data)$variable.labels[251] <- "[Mi-ar fi teamă de cineva dacă aș ști că are probleme emoționale sau de comportament.]"
...
attributes(data)$variable.labels[262] <- "[Sfârșec să petrec mai mult timp pe Social Media decât plănuiesc inițial. ]"
