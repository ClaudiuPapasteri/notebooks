...
Data_O4O2 <- rbind(cbind(Data_fem_O4O2, Gen = rep("f", nrow(Data_fem_O4O2))), cbind(Data_masc_O4O2, Gen = rep("m", nrow(Data_masc_O4O2))))


Data_O4O2$D_Ox <- Data_O4O2$OXT_Post - Data_O4O2$OXT_Pre
Data_O4O2$D_Vas_Stres <- Data_O4O2$Vas_Stres_Post - Data_O4O2$Vas_Stres_Pre
Data_O4O2$D_Vas_Bine <- Data_O4O2$Vas_Bine_Post - Data_O4O2$Vas_Bine_Pre




Data_fem_O4O2$D_Ox <- Data_fem_O4O2$OXT_Post - Data_fem_O4O2$OXT_Pre
Data_fem_O4O2$D_Vas_Stres <- Data_fem_O4O2$Vas_Stres_Post - Data_fem_O4O2$Vas_Stres_Pre
Data_fem_O4O2$D_Vas_Bine <- Data_fem_O4O2$Vas_Bine_Post - Data_fem_O4O2$Vas_Bine_Pre
Data_fem_O4O2$D_IOS <- Data_fem_O4O2$IOS_Post - Data_fem_O4O2$IOS_Pre


ggplot(Data_fem_O4O2, aes(D_Ox, D_Vas_Stres)) + 
  geom_point() +
  geom_smooth(method = "loess", se = FALSE)

ggplot(Data_fem_O4O2, aes(D_Ox, D_Vas_Bine)) + 
  geom_point() +
  geom_smooth(method = "loess", se = FALSE)

ggplot(Data_fem_O4O2, aes(D_Ox, D_IOS)) + 
  geom_point() +
  geom_smooth(method = "loess", se = FALSE)
