...
subtitle: "OXT and Psichological variables - By Gender"
...
```{r desc_gen_varsta}
describe(Data_merged_wide_all$Varsta)
prop.table(table(Data_merged_wide_all$Gen))

t.test(Data_merged_wide_all$Varsta ~ Data_merged_wide_all$Gen) %>%
  tidy()

wilcox.test(Data_merged_wide_all$Varsta ~ Data_merged_wide_all$Gen) %>%
  tidy()

psych::describeBy(Data_merged_wide_all$Varsta, group = Data_merged_wide_all$Gen)
```
...
func_t_box(Data_merged_wide_all, "ID", "OXT_Pre_ECRAN", "OXT_Post_ECRAN")   # ns

func_t_box(Data_merged_wide_all, "ID", "Vas_Stres_Pre_OGL", "Vas_Stres_Post_OGL")         # sig  
func_t_box(Data_merged_wide_all, "ID", "Vas_Stres_Pre_ECRAN", "Vas_Stres_Post_ECRAN")     # ns

func_t_box(Data_merged_wide_all, "ID", "Vas_Bine_Pre_OGL", "Vas_Bine_Post_OGL")           # ns  
func_t_box(Data_merged_wide_all, "ID", "Vas_Bine_Pre_ECRAN", "Vas_Bine_Post_ECRAN")       # sig

func_t_box(Data_merged_wide_all, "ID", "IOS_Pre_OGL", "IOS_Post_OGL")                     # sig  
func_t_box(Data_merged_wide_all, "ID", "IOS_Pre_ECRAN", "IOS_Post_ECRAN")                 # ns
```
...
func_ancova_multibox(Data_merged_wide_all,  "ID", "Vas_Stres_Pre_OGL", "Vas_Stres_Post_OGL", "Vas_Stres_Pre_ECRAN", "Vas_Stres_Post_ECRAN")    # ns

func_ancova_multibox(Data_merged_wide_all,  "ID", "Vas_Bine_Pre_OGL", "Vas_Bine_Post_OGL", "Vas_Bine_Pre_ECRAN", "Vas_Bine_Post_ECRAN")        # ns

func_ancova_multibox(Data_merged_wide_all,  "ID", "IOS_Pre_OGL", "IOS_Post_OGL", "IOS_Pre_ECRAN", "IOS_Post_ECRAN")                            # sig
...
# Females
cat("### Fem")
func_t_box(Data_fem, "ID", "OXT_Pre_OGL", "OXT_Post_OGL")    # sig
func_t_box(Data_fem, "ID", "OXT_Pre_ECRAN", "OXT_Post_ECRAN")   # ns

func_t_box(Data_fem, "ID", "Vas_Stres_Pre_OGL", "Vas_Stres_Post_OGL")         # sig 
...
# Males
cat("### Masc")
func_t_box(Data_masc, "ID", "OXT_Pre_OGL", "OXT_Post_OGL")    # ns
func_t_box(Data_masc, "ID", "OXT_Pre_ECRAN", "OXT_Post_ECRAN")   # ns
...
func_ancova_multibox(Data_fem, "ID", "Vas_Stres_Pre_OGL", "Vas_Stres_Post_OGL", "Vas_Stres_Pre_ECRAN", "Vas_Stres_Post_ECRAN")    # ns

func_ancova_multibox(Data_fem, "ID", "Vas_Bine_Pre_OGL", "Vas_Bine_Post_OGL", "Vas_Bine_Pre_ECRAN", "Vas_Bine_Post_ECRAN")        # ns

func_ancova_multibox(Data_fem, "ID", "IOS_Pre_OGL", "IOS_Post_OGL", "IOS_Pre_ECRAN", "IOS_Post_ECRAN")                            # sig
...
func_ancova_multibox(Data_masc, "ID", "Vas_Stres_Pre_OGL", "Vas_Stres_Post_OGL", "Vas_Stres_Pre_ECRAN", "Vas_Stres_Post_ECRAN")    # ns

func_ancova_multibox(Data_masc, "ID", "Vas_Bine_Pre_OGL", "Vas_Bine_Post_OGL", "Vas_Bine_Pre_ECRAN", "Vas_Bine_Post_ECRAN")        # ns

func_ancova_multibox(Data_masc, "ID", "IOS_Pre_OGL", "IOS_Post_OGL", "IOS_Pre_ECRAN", "IOS_Post_ECRAN")                            # sig
```
...
## Correlations between Diff_OXT_OGL with other variables

```{r D_cor_other, results='asis', warning=FALSE}
...
####
Data_difscores[,-c(1:2, 5:24)] %>%
   Correlations_With_One(., variable = "Diff_Vas_Stres_OGL", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05) # C,C5

###
Data_difscores[,-c(1:2, 5:24)] %>%
   Correlations_With_One(., variable = "Diff_Vas_Bine_OGL", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05)  # BDI
Data_difscores[,-c(1:2, 5:24)] %>%
   Correlations_With_One(., variable = "Diff_Vas_Bine_ECRAN", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05) # O2,O3, StaiT

```


```{r lm_var, results='asis', warning=FALSE}
lm(Vas_Stres_Post_OGL ~ Vas_Stres_Pre_OGL + StaiTbrut, data = Data_merged_wide_all) %>% summary()      # sig
lm(Vas_Stres_Post_ECRAN ~ Vas_Stres_Pre_ECRAN + StaiTbrut, data = Data_merged_wide_all) %>% summary()  # ns


lm(Vas_Bine_Post_OGL ~ Vas_Bine_Pre_OGL + ScorBDI, data = Data_merged_wide_all) %>% summary()        # sig
lm(Vas_Bine_Post_ECRAN ~ Vas_Bine_Pre_ECRAN + ScorBDI, data = Data_merged_wide_all) %>% summary()    # ns
...
## Correlations between Diff_OXT_OGL with other variables - by Gender

```{r D_cor_other_gen, results='asis', warning=FALSE}
## Correlations between Diffrence Scores with other variables - Females
cat("### Females")
Data_difscores[,-c(1:2, 5:24)] %>%
  filter(Gen == "f") %>%
  Correlations_With_One(., variable = "Diff_OXT_OGL", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05)   # nothing
...
Data_difscores[,-c(1:2, 5:24)]%>%
  filter(Gen == "f") %>%
   Correlations_With_One(., variable = "Diff_Vas_Stres_OGL", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05) # A1

###
Data_difscores[,-c(1:2, 5:24)] %>%
  filter(Gen == "f") %>%
  Correlations_With_One(., variable = "Diff_Vas_Bine_OGL", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05)  # BDI, N2
Data_difscores[,-c(1:2, 5:24)] %>%
  filter(Gen == "f") %>%
  Correlations_With_One(., variable = "Diff_Vas_Bine_ECRAN", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05) # StaiT




## Correlations between Diffrence Scores with other variables - Males
cat("### Males")
Data_difscores[,-c(1:2, 5:24)] %>%
  filter(Gen == "m") %>%
...
Data_difscores[,-c(1:2, 5:24)] %>%
  filter(Gen == "m") %>%
  Correlations_With_One(., variable = "Diff_Vas_Stres_OGL", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05) # C2-Ordine!!!

###
Data_difscores[,-c(1:2, 5:24)] %>%
  filter(Gen == "m") %>%
  Correlations_With_One(., variable = "Diff_Vas_Bine_OGL", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05)  # nothing
Data_difscores[,-c(1:2, 5:24)] %>%
  filter(Gen == "m") %>%
  Correlations_With_One(., variable = "Diff_Vas_Bine_ECRAN", correlation_abs_threshold = 0.2, pvalue_threshold = 0.05) # C2-Ordine,O2
...
summary(lm(Diff_OXT_OGL ~ Diff_Vas_Stres_OGL, data = df_cordif_fem))   # ns

withinmed_OGL <- 
  mdt_within_wide(data = Data_fem, 
                  DV_A = Vas_Stres_Pre_OGL, DV_B = Vas_Stres_Post_OGL, 
                  M_A = OXT_Pre_OGL, M_B = OXT_Post_OGL)
add_index(withinmed_OGL)

withinmed_ECRAN <- 
  mdt_within_wide(data = Data_fem, 
                  DV_A = Vas_Stres_Pre_ECRAN, DV_B = Vas_Stres_Post_ECRAN, 
                  M_A = OXT_Pre_ECRAN, M_B = OXT_Post_ECRAN)
add_index(withinmed_ECRAN)
...
## Correlations with OxT

```{r cor_OXT, fig.width=8, fig.height=7, results='asis'}
