...
batch_extract <- function(folder){     # outside lopp call: do.call(dplyr::bind_rows, data_list)
...
sessions_folder <- "C:/Users/claud/Desktop/Desktop/aaa new Desktop/STAD/Sessions_Clean"
main_folder <- "C:/Users/claud/Desktop/Desktop/aaa new Desktop/STAD/Sessions_Clean_demoimitMectrics"
setwd(main_folder)

folder_paths <- dir(sessions_folder, full.names = TRUE, recursive = FALSE)
