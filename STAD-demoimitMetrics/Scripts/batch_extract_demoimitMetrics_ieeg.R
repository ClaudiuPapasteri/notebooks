...
botrec_clean_folder <- "C:/Users/claud/Desktop/Desktop/aaa new Desktop/STAD/Sessions_SSM_Clean/Clean_Sessions_ieeg/output_file"
out_folder <- "C:/Users/claud/Desktop/Desktop/aaa new Desktop/STAD/Sessions_SSM_Clean"
setwd(botrec_clean_folder)

file_paths <- dir(botrec_clean_folder, full.names = TRUE, recursive = FALSE, pattern = "*_clean\\.botrec")
file_names <- basename(file_paths)

sessions_clean_ieeg <- batch_extract(botrec_clean_folder)

# saveRDS(sessions_clean_ieeg, file = file.path(out_folder, "sessions_clean_ieeg.RDS"))
