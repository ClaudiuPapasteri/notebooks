...
indiv_slope_df <- 
  recomputed_df %>%
    ...
    dplyr::ungroup() %>%
    dplyr::group_nest(output_file, id, condition, cond_ord) %>%                      # break out the data by this columns using dplyr::group_nest()
...
# fast_png(indiv_slope_ttest_condord, path = graphs_out_folder, width = 14, height = 10)
