...
jrad_zi2 <-
  df_zi2 %>%
  dplyr::rename(Data = `ZI 2`) %>%
  dplyr::select(ID, Conditie, Data, starts_with("StaiS_"), starts_with("PA_"), starts_with("NA_"), 
         APS_pre, APS_post,
...
# saveRDS(long_df_all, "O1b data - ordering.RDS")
